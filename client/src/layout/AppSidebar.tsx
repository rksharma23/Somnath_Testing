...
const AppSidebar: React.FC = () => {
  ...
  console.log("AppSidebar rendered, current location:", location.pathname);
  ...
  const isActive = useCallback(
    (path: string) => {
      ...
      console.log(`Checking if ${path} is active: ${isActivePath} (current: ${location.pathname})`);
      return isActivePath;
    },
    [location.pathname]
  );
                  ...
                  <li key={subItem.name}>
                    <Link
                      ...
                      onClick={(e) => {
                        ...
                        console.log('Submenu click event:', e);
                      }}
                    >
                      {subItem.name}
